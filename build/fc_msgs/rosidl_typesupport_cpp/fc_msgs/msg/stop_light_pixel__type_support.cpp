...
static const _StopLightPixel_type_support_symbol_names_t _StopLightPixel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fc_msgs, msg, StopLightPixel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fc_msgs, msg, StopLightPixel)),
  }
};
...
{
  return &::fc_msgs::msg::rosidl_typesupport_cpp::StopLightPixel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fc_msgs, msg, StopLightPixel)() {
  return get_message_type_support_handle<fc_msgs::msg::StopLightPixel>();
}
